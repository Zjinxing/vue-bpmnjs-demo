export default {
  ...
  'Candidate Starter Configuration': '启动器配置',
  ...
  'Connector': '连接器',
  'Process_1': '进程-1',
  'This maps to the process definition key.': '映射流程定义键',
  'Name': '名称',
  'Version Tag': '版本标签',
  'Task Priority': '任务优先级',
  'Job Priority': '工作优先级',
  'Executable': '可执行',
  'Candidate Starter Groups': '启动器组',
  'Candidate Starter Users': '启动器用户',
  'History Time To Live': '生命周期',
  'Startable': '重启',
  ...
  'Process Documentation': '文档流程',
  'Process Id': '进程 Id',
  'Process Name': '进程名',
  'Initiator': '发起人',
  'Specify more than one group as a comma separated list.': '多个组用逗号分隔',
  'Specify more than one user as a comma separated list.': '多个用户逗号分隔',
